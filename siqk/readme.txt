For clarity, suppose your your C++ compiler is g++-4.7 in what follows. But it
can be something else.

1. Get and install the standalone Kokkos TPL:

$ git clone https://github.com/kokkos/kokkos.git
$ ./kokkos/generate_makefile.bash --with-openmp --ldflags=-fPIC --prefix=/path/to/desired/installation --compiler=g++-4.7
